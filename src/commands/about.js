exports.run = function (client, msg) {
    ...
    msg.channel.createMessage({embed:{
        ...
        ("I'm a multi-purpose discord bot that does moderation and other fun and useful things coded in NodeJS and the library used is [Eris](http://npmjs.com/package/eris). Why Eris? Eris is fast, lightweight, consistent,") + 
